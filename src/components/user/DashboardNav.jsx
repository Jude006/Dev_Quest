      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="items-center hidden space-x-6 md:flex">
            <Link to='/user/challenge' className="flex items-center text-cyber-purple-300">
              <Zap className="w-4 h-4 mr-1 text-cyber-yellow" />
              <span className="text-sm font-medium">Daily Challenge</span>
            </Link>
            
            <div className="flex items-center text-cyber-purple-300">
              <div className="w-2 h-2 mr-1 rounded-full bg-matrix-green animate-pulse" />
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:block">
              <div className="text-sm font-medium text-white">CodeMaster</div>
              <div className="text-xs text-cyber-purple-300">Level 7 Developer</div>
            </div>
